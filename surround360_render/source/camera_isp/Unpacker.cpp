...
// cubox default GOOGLE_STRIP_LOG == 0 (See /tmp/Unpacker.Surround360-RTX8000.cubox.log.INFO.20240415-162330.4301)
      ...
      auto taskHandle = async(
        ...
        [=, &footageFile, &serialNumbers] {
          ...
          for (int frameIndex = startFrame; frameIndex <= endFrame; ++frameIndex) {
            ...
            if (serial < 1000) { // cubox add
              LOG(FATAL) << "[cubox] Looking for serial number " << serial << ", frameIndex=" << frameIndex << endl;
            }
